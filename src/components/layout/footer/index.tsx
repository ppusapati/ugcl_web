...
export default component$(() => {
  return (<>
  <footer class="bg-white rounded-lg shadow flex flex-col items-center justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 ">
  <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
      &copy; 2024 Powered by <a href="#" class="hover:underline" target="_blank">Shreem</a>. All rights reserved.
  </p>
